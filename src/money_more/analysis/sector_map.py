...
_INDUSTRY_ALIASES = (
    ...
    (("保险",), "保险"),
    (("证券", "券商"), "券商"),
    (("半导体", "芯片", "集成电路", "封测", "光刻", "晶圆", "存储芯片"), "半导体"),
    (("光模块", "光通信", "光纤", "光器件"), "通信"),
    (("显示器件", "面板", "液晶", "OLED"), "元件"),
    (("电子化学品", "电子化学", "湿电子", "光刻胶", "电子气体"), "电子化学品"),
    (("元件", "PCB", "被动元件", "连接器", "电容", "电阻"), "元件"),
    (("光伏", "电池", "锂电", "新能源", "风电", "储能", "动力电池"), "新能源"),
    (("安防", "安防设备", "智能安防"), "元件"),
...
_THEME_MEMBERS: dict[str, frozenset[str]] = {
    "科技硬件": frozenset({"半导体", "元件", "电子化学品", "软件", "通信", "传媒"}),
    "新能源": frozenset({"新能源"}),
    "金融": frozenset({"银行", "保险", "券商"}),
    "消费": frozenset({"白酒", "食品饮料", "家电", "旅游"}),
    "医药": frozenset({"医药"}),
    "周期": frozenset({"有色", "煤炭", "石油石化", "军工", "电力", "汽车", "地产", "建材"}),
}
